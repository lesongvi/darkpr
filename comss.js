var commentusername = ["ready", "Nguyễn Văn Trung", "Nguyễn Ngọc Thái", "Phú Nam", "Tú Bảnh", "Lâm Bastian", "Hoàng Dương Trung", "Nah Rappvn", "Minh Acơ", "Ivan Đông", "Linh KAKA", "Phụng Bư", "Lê Song Vĩ", "Mađam Sơn", "Long Phi", "Bin Nguyễn", "Tùng Tây", "Thái Đức", "Dũng Lucas", "Karik Nguyễn", "Phúc Đen", "", "200000", "400000", "600000", "800000", "1000000", "1000000", "1000000", "1000000", "1000000", "1000000", "1000000", "EP FIFA ONLINE", "! ", ". ", ".. ", " ", "Wow", "WOW", "wow", "Thật tuyệt vời ", "ôi trời nó có thật", "phần mềm này thật tuyệt vời ", "Tôi cảm ơn nhiều ", "web này rất ngon ", "cảm ơn vì đã chia sẽ ", "không thể diễn tả cảm xúc phê hiện tại", "100m cmnr", "ngon đấy ", "cảm ơn bạn founder nhé ", " ", " ", " ", "", " ", "", "", "", "", "", "", "cảm ơn bạn vì đã chia sẽ nhé ", "cảm ơn quản trị viên nhé, nó đã hoạt động, ít nhất là với tôi!", "hack được rồi, cảm ơn nheièu ", "i wonder why this wasnâ€™t on the news. this is stunning tool! ", "Cảm ơn rất rất rất là nhiều ", "TUYỆT TÁC!!", " Cảm ơn và â€¦ đây là lần đầu tiên tôi hack fo3, cảm giác rất tuyệt vời ", "quá đỉnh!!! TKSSSSSSSSS. ", "cảm ơn admin đã tạo ra trang web hack này ", "cảm ơn rất nhiều! ", "", "", "", "", "", "", "", "", "", "", "", "", " ", " ", " ", " ", "  ", " ", "", "", "", "", "nó hoạt động, nhưng tôi lo sợ nó sẽ làm nhều người bị khóa tài khoản ", "thank u nhiều! ", "Hoàn hảo! đây là những gì tôi đang tìm! ", "Good jobâ€¦ cảm ơn vì đã public trang web  ", " ", " ", " ", "cảm ơn", "cảm ơn rất nhiều", "thank ^^ ", "thank you from Korea", "cảm ơn bạn đã làm web", "cảm ơn nhiều nha", "tôi cảm ơn", "phục bạn nhiều rồi đó", ":D ", ":3 ", ":) ", "c: ", "=D ", "=3 ", "=) ", "c= ", "commented", "state-disabled", "addClass", "#commentUsernameLabel", "disabled", "attr", "#commentUsername", "#commentCommentLabel", "#commentComment", "comment1Cookie", "username1Cookie", "username2Cookie", "username3Cookie", "timePosted11Cookie", "timePosted22Cookie", "timePosted33Cookie", "comment2Cookie", "comment3Cookie", "click", "#commentSubmit", "random", "floor", "join", "length", "html", "#username", " ", "#comment", "#timePosted", "Vài giây trước", "Một phúc trước", "Đã đăng ", " 1 phút trước", "round", "val", "state-error", "getTime", "setTime", "; expires=", "toGMTString", "cookie", "=", "; path=/", ";", "split", "substring", "charAt", "indexOf"];
