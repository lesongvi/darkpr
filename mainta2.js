            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ...
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'Thằng lồn ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' ra đây bố mày bảo, thích thì vào solo 1 trận. Sủa lắm vl');
